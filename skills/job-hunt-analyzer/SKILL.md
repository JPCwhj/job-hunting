...
**规则一：区块级跳过**
专业技能、教育背景、个人信息、自我评价、证书奖项等区块整体跳过，语义判断，不限死名称。
工作/教育合并区块（如「工作及教育经历」）不整体跳过，进入规则二逐行判断。

**规则二：行级跳过**
工作/项目经历区块内，同时满足以下两条的行跳过：
- 没有行动动词（做了什么）
- 没有结果描述（达成了什么）

⚠️ 部门名/组织名中的词语（如「运营组」「品牌部」「产品中心」）不算行动动词。
典型跳过示例：
