...
- 🔗 [打开 JD](<url>)
- 📄 [定制简历](<work_dir>/output/<run_id>/tailored/boss-<id>/resume.md) · 💬 [开场白](<work_dir>/output/<run_id>/tailored/boss-<id>/opener.md) · 📋 [改动](<work_dir>/output/<run_id>/tailored/boss-<id>/changelog.md)
